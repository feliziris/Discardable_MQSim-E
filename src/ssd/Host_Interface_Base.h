...
#define DELETE_REQUEST_NVME(REQ) \
	...
	public:
		...
		unsigned int STAT_number_of_trim_transactions;
		sim_time_type STAT_sum_of_trim_transactions_execution_time, STAT_sum_of_trim_transactions_transfer_time, STAT_sum_of_trim_transactions_waiting_time;
#endif
	};
