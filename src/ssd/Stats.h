...
namespace SSD_Components
{
	...
	public:
		...
		static unsigned int total_CMT_queries, total_readTR_CMT_queries, total_writeTR_CMT_queries, total_trimTR_CMT_queries;
		...
		static unsigned int total_CMT_queries_per_stream[MAX_SUPPORT_STREAMS], total_readTR_CMT_queries_per_stream[MAX_SUPPORT_STREAMS], total_writeTR_CMT_queries_per_stream[MAX_SUPPORT_STREAMS], total_trimTR_CMT_queries_per_stream[MAX_SUPPORT_STREAMS];
