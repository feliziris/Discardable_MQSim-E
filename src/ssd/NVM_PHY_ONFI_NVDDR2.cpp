...
#ifdef HYLEE
	void NVM_PHY_ONFI_NVDDR2::handle_ready_signal_from_FTL(SSD_Components::NVM_Transaction_Flash* transaction)
	{
		if (transaction->Type == Transaction_Type::TRIM) {
			_my_instance->broadcastTransactionServicedSignal(transaction);
		}
	}
#endif
