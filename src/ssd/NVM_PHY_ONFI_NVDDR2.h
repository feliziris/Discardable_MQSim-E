...
namespace SSD_Components
{
	...
	public:
		...
		void Set_metadata(flash_channel_ID_type channel_id, flash_chip_ID_type chip_id,flash_die_ID_type die_id, flash_plane_ID_type plane_id, flash_block_ID_type block_id, flash_page_ID_type page_id, flash_page_ID_type subpage_id, LPA_type lpa); //JY_Modified
...
#ifdef HYLEE
		void handle_ready_signal_from_FTL(NVM_Transaction_Flash*);
#endif
	private:
