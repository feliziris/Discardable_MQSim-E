#ifndef NVM_TRANSACTION_FLASH_TR
#define NVM_TRANSACTION_FLASH_TR
...
namespace SSD_Components
{
	...
	class NVM_Transaction_Flash_TR : public NVM_Transaction_Flash
	{
	public:
		NVM_Transaction_Flash_TR(Transaction_Source_Type source, stream_id_type stream_id,
